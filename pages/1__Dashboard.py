...
# Tableau dashboard 1 embed code
...
# Sentiment Analysis Dashboard embed code
...
if dashboard_choice == "Airbnb Data Insight":
    ...
    components.html(dashboard1_embed_code, height=1000, width= 1280)
...
if dashboard_choice == "Sentiment Analysis of reviews":
    ...
    components.html(sentiment_dashboard_embed_code, height=1000, width= 1280)